...
export function EntriesProvider({ children }: { children: ReactNode }) {
  const [entries, setEntries] = useState<Entry[]>([
    ...
    },
    {
      ...
      preview: '#Sample I am not sure what I am feeling today',
      mood: 'frustrated',
      title: 'Shutdown Episode',
      content: "I shut down mid-task again. Everything suddenly felt overwhelming and painful— the lights, the to-dos, even my own thoughts. I sat on the floor for an hour. When I finally opened the app and saw the breathing exercise I saved last month, I did it twice. It didn't fix everything, but it helped me move to the next step: brushing my teeth.",
